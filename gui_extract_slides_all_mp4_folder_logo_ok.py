...
from PIL import Image, ImageTk  # Thêm thư viện PIL để xử lý ảnh
import os
import glob
import cv2
...
# Thêm logo vào GUI
logo_path = "nct_logo.png"  # Đường dẫn đến file logo
if os.path.exists(logo_path):
    img = Image.open(logo_path)
    img = img.resize((150, 150), Image.Resampling.LANCZOS)  # Thay ANTIALIAS bằng LANCZOS
